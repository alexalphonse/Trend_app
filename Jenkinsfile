pipeline {
    ...
    environment {
        DOCKER_IMAGE = 'alexalphonse/trend-app'
    ...
    stages {
        stage('Checkout Code') {
            steps {
                git branch: 'main', url: 'https://github.com/alexalphonse/Trend-App.git'
            }
        }
    ...
    post {
        ...
        success {
            echo '✅ Trend App Deployment Successful!'
            script {
                ...
                echo "��� Your application is live at: http://${LB_URL}"
            }
        }
        failure {
